...
var style_Total_1 = function(feature, resolution){
    ...
    var labelText = ""; 
    var value = feature.get("Jumlah Anggota DPRD_Total");
    ...
    if (value >= 19.000000 && value <= 23.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 23.200000 && value <= 27.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 27.400000 && value <= 31.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 35.800000 && value <= 40.000000) {
            style = [ new ol.style.Style({
